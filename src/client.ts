...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['HELLO_WORLD_TESTINGGGG_BASE_URL'].
   */
...
export class HelloWorldTestingggg {
  ...
  protected async authHeaders(opts: FinalRequestOptions): Promise<NullableHeaders | undefined> {
    return buildHeaders([await this.petstoreAuth(opts), await this.apiKeyAuth(opts)]);
  }

  protected async petstoreAuth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined> {
    return undefined;
  }
  ...
  static HelloWorldTestingggg = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static HelloWorldTestinggggError = Errors.HelloWorldTestinggggError;
