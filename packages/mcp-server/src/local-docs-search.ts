...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'health',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(\n  apiKey: 'My API Key',\n  basicAuthUsername: 'My Basic Auth Username',\n  basicAuthPassword: 'My Basic Auth Password',\n);\n\n$systemHealth = $client->health();\n\nvar_dump($systemHealth);",
      },
      csharp: {
        method: 'Health',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'retrieveRateLimits',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->retrieveRateLimits();\n\nvar_dump($response);",
      },
      csharp: {
        method: 'RetrieveRateLimits',
        example:
  ...
  },
  {
    ...
    response:
      "{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }",
    markdown:
      "## list\n\n`client.pet.list(created_at?: { gt?: string; gte?: string; lt?: string; lte?: string; }, cursor?: string, limit?: number): { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }`\n\n**get** `/pet`\n\nReturns a cursor-paginated list of pets.\n\n### Parameters\n\n- `created_at?: { gt?: string; gte?: string; lt?: string; lte?: string; }`\n  Filter by created_at timestamp range in UTC. Accepts gt/gte/lt/lte.\n  - `gt?: string`\n    Minimum value to filter by (exclusive).\n  - `gte?: string`\n    Minimum value to filter by (inclusive).\n  - `lt?: string`\n    Maximum value to filter by (exclusive).\n  - `lte?: string`\n    Maximum value to filter by (inclusive).\n\n- `cursor?: string`\n  Cursor from a previous response used to fetch the next page.\n\n- `limit?: number`\n  Maximum number of pets to return.\n\n### Returns\n\n- `{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n\n  - `name: string`\n  - `photoUrls: string[]`\n  - `id?: number`\n  - `acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string`\n  - `category?: object`\n  - `microchipId?: string | number`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedUser?: object`\n  - `status?: 'available' | 'pending' | 'sold'`\n  - `tags?: object[]`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\n// Automatically fetches more pages as needed.\nfor await (const pet of client.pet.list()) {\n  console.log(pet);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ items: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }[]; next_cursor?: string; }",
    markdown:
    ...
    perLanguage: {
      ...
      php: {
        method: 'pet->listUnpaginated',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client();\n\n$response = $client->pet->listUnpaginated(cursor: 'cursor', limit: 0);\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Pet.ListUnpaginated',
        example:
  ...
  },
  {
    ...
    response:
      "{ data: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }[]; has_more: boolean; }",
    markdown:
    ...
    perLanguage: {
      ...
      php: {
        method: 'pet->listFakePage',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client();\n\n$response = $client->pet->listFakePage();\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Pet.ListFakePage',
        example:
  ...
  },
  {
    ...
    response:
      "{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }",
    markdown:
      "## list_fake_page_inferred\n\n`client.pet.listFakePageInferred(): { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }`\n\n**get** `/pet/fake-page-inferred`\n\nReturns a single page-shaped pet response whose fake pagination behavior is inferred from the config scheme.\n\n### Returns\n\n- `{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n\n  - `name: string`\n  - `photoUrls: string[]`\n  - `id?: number`\n  - `acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string`\n  - `category?: object`\n  - `microchipId?: string | number`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedUser?: object`\n  - `status?: 'available' | 'pending' | 'sold'`\n  - `tags?: object[]`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\n// Automatically fetches more pages as needed.\nfor await (const pet of client.pet.listFakePageInferred()) {\n  console.log(pet);\n}\n```",
    perLanguage: {
      typescript: {
      ...
      php: {
        method: 'pet->listFakePageInferred',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client();\n\n$page = $client->pet->listFakePageInferred();\n\nvar_dump($page);",
      },
      csharp: {
        method: 'Pet.ListFakePageInferred',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'pet->listLeaderboard',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(\n  apiKey: 'My API Key',\n  basicAuthUsername: 'My Basic Auth Username',\n  basicAuthPassword: 'My Basic Auth Password',\n);\n\n$response = $client->pet->listLeaderboard();\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Pet.ListLeaderboard',
        example:
  ...
  },
  {
    ...
    params: [
      ...
      'id?: number;',
      "acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string;",
      "category?: { id?: number; name?: string; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; subcategories?: object[]; };",
      'microchipId?: string | number;',
      "relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; };",
      "relatedCategory?: { id?: number; name?: string; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; subcategories?: object[]; };",
      "relatedCustomer?: { id?: number; address?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }[]; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; username?: string; };",
      "relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; };",
      "relatedOrder?: { id?: number; complete?: boolean; petId?: number; quantity?: number; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; shipDate?: string; status?: 'placed' | 'approved' | 'delivered'; total?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; };",
      "relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; };",
      "relatedShelter?: { name: string; address?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; contact?: { primary?: { availability?: { weekday?: object; weekend?: object; }; name?: string; phone?: string; }; }; location?: { latitude: number; longitude: number; }; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedTag?: object; relatedUser?: object; };",
      "relatedUser?: { id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; };",
      "status?: 'available' | 'pending' | 'sold';",
      "tags?: { id?: number; name?: string; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; }[];",
    ],
    response:
      "{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }",
    markdown:
      "## update\n\n`client.pet.update(name: string, photoUrls: string[], id?: number, acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string, category?: { id?: number; name?: string; relatedAddress?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; subcategories?: object[]; }, microchipId?: string | number, relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }, relatedCategory?: { id?: number; name?: string; relatedAddress?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; subcategories?: object[]; }, relatedCustomer?: { id?: number; address?: object[]; relatedAddress?: object; relatedCategory?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; username?: string; }, relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }, relatedOrder?: { id?: number; complete?: boolean; petId?: number; quantity?: number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; shipDate?: string; status?: 'placed' | 'approved' | 'delivered'; total?: object; }, relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }, relatedShelter?: { name: string; address?: object; contact?: { primary?: object; }; location?: { latitude: number; longitude: number; }; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedTag?: object; relatedUser?: object; }, relatedUser?: { id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }, status?: 'available' | 'pending' | 'sold', tags?: { id?: number; name?: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; }[]): { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }`\n\n**put** `/pet`\n\nUpdate an existing pet by Id\n\n### Parameters\n\n- `name: string`\n\n- `photoUrls: string[]`\n\n- `id?: number`\n\n- `acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string`\n  How the pet entered the store. Open enum: known channels plus forward-compatible free-form strings.\n\n- `category?: { id?: number; name?: string; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; subcategories?: object[]; }`\n  - `id?: number`\n  - `name?: string`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n  - `subcategories?: object[]`\n    Nested subcategories; the tree can recurse arbitrarily deep.\n\n- `microchipId?: string | number`\n  Microchip identifier; legacy chips used numeric identifiers.\n\n- `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `city?: string`\n  - `geo?: { latitude: number; longitude: number; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n  - `state?: string`\n  - `street?: string`\n  - `zip?: string`\n\n- `relatedCategory?: { id?: number; name?: string; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; subcategories?: object[]; }`\n  - `id?: number`\n  - `name?: string`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n  - `subcategories?: object[]`\n    Nested subcategories; the tree can recurse arbitrarily deep.\n\n- `relatedCustomer?: { id?: number; address?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }[]; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; username?: string; }`\n  - `id?: number`\n  - `address?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }[]`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n  - `username?: string`\n\n- `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `amount: number`\n    Amount in minor currency units (e.g. cents).\n  - `currency: string`\n    ISO 4217 currency code.\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n\n- `relatedOrder?: { id?: number; complete?: boolean; petId?: number; quantity?: number; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; shipDate?: string; status?: 'placed' | 'approved' | 'delivered'; total?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; }`\n  - `id?: number`\n  - `complete?: boolean`\n  - `petId?: number`\n  - `quantity?: number`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n  - `shipDate?: string`\n  - `status?: 'placed' | 'approved' | 'delivered'`\n    Order Status\n  - `total?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n\n- `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `name: string`\n  - `photoUrls: string[]`\n  - `id?: number`\n  - `acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string`\n    How the pet entered the store. Open enum: known channels plus forward-compatible free-form strings.\n  - `category?: object`\n  - `microchipId?: string | number`\n    Microchip identifier; legacy chips used numeric identifiers.\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedUser?: object`\n  - `status?: 'available' | 'pending' | 'sold'`\n    pet status in the store\n  - `tags?: object[]`\n\n- `relatedShelter?: { name: string; address?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; contact?: { primary?: { availability?: { weekday?: object; weekend?: object; }; name?: string; phone?: string; }; }; location?: { latitude: number; longitude: number; }; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedTag?: object; relatedUser?: object; }`\n  - `name: string`\n  - `address?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `contact?: { primary?: { availability?: { weekday?: { close?: string; open?: string; }; weekend?: { close?: string; open?: string; }; }; name?: string; phone?: string; }; }`\n  - `location?: { latitude: number; longitude: number; }`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n\n- `relatedUser?: { id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }`\n  - `id?: number`\n  - `email?: string`\n  - `firstName?: string`\n  - `lastName?: string`\n  - `password?: string`\n  - `phone?: string`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `username?: string`\n  - `userStatus?: number`\n    User Status\n\n- `status?: 'available' | 'pending' | 'sold'`\n  pet status in the store\n\n- `tags?: { id?: number; name?: string; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; }[]`\n\n### Returns\n\n- `{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n\n  - `name: string`\n  - `photoUrls: string[]`\n  - `id?: number`\n  - `acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string`\n  - `category?: object`\n  - `microchipId?: string | number`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedUser?: object`\n  - `status?: 'available' | 'pending' | 'sold'`\n  - `tags?: object[]`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst pet = await client.pet.update({ name: 'doggie', photoUrls: ['string'] });\n\nconsole.log(pet);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    endpoint: '/pet/search',
    httpMethod: 'get',
    summary: 'Search pets with typed query filters',
    description:
      'Typed query-parameter probe matrix: an object-schema query param mints a typed params model, an array-of-object query param mints a singularized element type, an empty object (additionalProperties:false) stays a bare object, and a scalar stays scalar. Isolates the emitter query-parameter type-resolution branches so object/array-of-object/empty-object params are each exercised.',
    stainlessPath: '(resource) pet > (method) search',
    qualified: 'client.pet.search',
    params: [
      'filters?: { color?: string; size?: number; };',
      'max_results?: number;',
      'raw_filter?: object;',
      "tag_filters?: { key?: string; match?: 'exact' | 'prefix'; }[];",
    ],
    response:
      "{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }[]",
    markdown:
      "## search\n\n`client.pet.search(filters?: { color?: string; size?: number; }, max_results?: number, raw_filter?: object, tag_filters?: { key?: string; match?: 'exact' | 'prefix'; }[]): object[]`\n\n**get** `/pet/search`\n\nTyped query-parameter probe matrix: an object-schema query param mints a typed params model, an array-of-object query param mints a singularized element type, an empty object (additionalProperties:false) stays a bare object, and a scalar stays scalar. Isolates the emitter query-parameter type-resolution branches so object/array-of-object/empty-object params are each exercised.\n\n### Parameters\n\n- `filters?: { color?: string; size?: number; }`\n  Object-schema query parameter: mints a typed params model instead of collapsing to a bare object.\n  - `color?: string`\n  - `size?: number`\n\n- `max_results?: number`\n  Scalar query parameter: stays a plain scalar (control probe).\n\n- `raw_filter?: object`\n  Empty-object query parameter (additionalProperties:false): stays a bare object, exercising the empty-object branch.\n\n- `tag_filters?: { key?: string; match?: 'exact' | 'prefix'; }[]`\n  Array-of-object query parameter: emitters mint a singularized element type for each item.\n\n### Returns\n\n- `{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }[]`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst pets = await client.pet.search();\n\nconsole.log(pets);\n```",
    perLanguage: {
      typescript: {
        method: 'client.pet.search',
        example:
          "import HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst pets = await client.pet.search();\n\nconsole.log(pets);",
      },
      python: {
        method: 'pet.search',
        example:
          'from hello_world_testingggg import HelloWorldTestingggg\n\nclient = HelloWorldTestingggg()\npets = client.pet.search()\nprint(pets)',
      },
      java: {
        method: 'pet().search',
        example:
          'package com.hello_world_testingggg.api.example;\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient;\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient;\nimport com.hello_world_testingggg.api.models.Pet;\nimport com.hello_world_testingggg.api.models.PetSearchParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        HelloWorldTestinggggClient client = HelloWorldTestinggggOkHttpClient.fromEnv();\n\n        List<Pet> pets = client.pet().search();\n    }\n}',
      },
      kotlin: {
        method: 'pet().search',
        example:
          'package com.hello_world_testingggg.api.example\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient\nimport com.hello_world_testingggg.api.models.Pet\nimport com.hello_world_testingggg.api.models.PetSearchParams\n\nfun main() {\n    val client: HelloWorldTestinggggClient = HelloWorldTestinggggOkHttpClient.fromEnv()\n\n    val pets: List<Pet> = client.pet().search()\n}',
      },
      go: {
        method: 'client.Pet.Search',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/swagger-girly/go"\n)\n\nfunc main() {\n\tclient := helloworldtestingggg.NewClient()\n\tpets, err := client.Pet.Search(context.TODO(), helloworldtestingggg.PetSearchParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", pets)\n}\n',
      },
      ruby: {
        method: 'pet.search',
        example:
      ...
      php: {
        method: 'pet->search',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client();\n\n$pets = $client->pet->search(\n  filters: ['color' => 'color', 'size' => 0],\n  maxResults: 0,\n  rawFilter: (object) [],\n  tagFilters: [['key' => 'key', 'match' => 'exact']],\n);\n\nvar_dump($pets);",
      },
      csharp: {
        method: 'Pet.Search',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'pet->retrievePremium',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->pet->retrievePremium(0);\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Pet.RetrievePremium',
        example:
  ...
  },
  {
    ...
    response:
      "{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }",
    markdown:
      "## watch_status\n\n`client.pet.watchStatus(petId: number, Last-Event-ID?: string): { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }`\n\n**get** `/pet/{petId}/status/stream`\n\nStreams pet status updates over Server-Sent Events. Each `status` event contains a full `Pet` payload.\n\n### Parameters\n\n- `petId: number`\n\n- `Last-Event-ID?: string`\n\n### Returns\n\n- `{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n\n  - `name: string`\n  - `photoUrls: string[]`\n  - `id?: number`\n  - `acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string`\n  - `category?: object`\n  - `microchipId?: string | number`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedUser?: object`\n  - `status?: 'available' | 'pending' | 'sold'`\n  - `tags?: object[]`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst stream = await client.pet.watchStatus(0);\nfor await (const pet of stream) {\n  console.log(pet);\n}\n```",
    perLanguage: {
      typescript: {
      ...
      php: {
        ...
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$pet = $client->pet->watchStatusStream(0, lastEventID: 'Last-Event-ID');\n\nvar_dump($pet);",
      },
      csharp: {
        method: 'Pet.WatchStatusStreaming',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        example:
          'package com.hello_world_testingggg.api.example;\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient;\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient;\nimport com.hello_world_testingggg.api.models.PetConnectParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        HelloWorldTestinggggClient client = HelloWorldTestinggggOkHttpClient.fromEnv();\n\n        client.pet().connect("petId");\n    }\n}',
      },
      kotlin: {
        example:
          'package com.hello_world_testingggg.api.example\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient\nimport com.hello_world_testingggg.api.models.PetConnectParams\n\nfun main() {\n    val client: HelloWorldTestinggggClient = HelloWorldTestinggggOkHttpClient.fromEnv()\n\n    client.pet().connect("petId")\n}',
      ...
      php: {
        method: 'pet->connect',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(\n  apiKey: 'My API Key',\n  basicAuthUsername: 'My Basic Auth Username',\n  basicAuthPassword: 'My Basic Auth Password',\n);\n\n$result = $client->pet->connect('petId');\n\nvar_dump($result);",
      },
      csharp: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'files->delete',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$result = $client->files->delete('path');\n\nvar_dump($result);",
      },
      csharp: {
        method: 'Files.Delete',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'files->uploadDirect',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$file = $client->files->uploadDirect(\n  FileParam::fromString('Example data', filename: uniqid('file-upload-', true))\n);\n\nvar_dump($file);",
      },
      csharp: {
        method: 'Files.UploadDirect',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'files->createArchive',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$archive = $client->files->createArchive(\n  files: [\n    FileParam::fromString('Example data', filename: uniqid('file-upload-', true)),\n  ],\n  manifest: ['name' => 'name', 'labels' => ['string'], 'preservePaths' => true],\n);\n\nvar_dump($archive);",
      },
      csharp: {
        method: 'Files.CreateArchive',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'profiles->retrieve',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$profile = $client->profiles->retrieve('profileId');\n\nvar_dump($profile);",
      },
      csharp: {
        method: 'Profiles.Retrieve',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'profiles->legacySearch',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$profiles = $client->profiles->legacySearch(includeArchived: true, q: 'q');\n\nvar_dump($profiles);",
      },
      csharp: {
        method: 'Profiles.LegacySearch',
        example:
  ...
  },
  {
    ...
    params: [
      "{ applicant_type: 'individual'; name: string; address?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; age?: number; email?: string; } | { applicant_type: 'organization'; name: string; shelter?: { name: string; address?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; contact?: { primary?: { availability?: object; name?: string; phone?: string; }; }; location?: { latitude: number; longitude: number; }; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedTag?: object; relatedUser?: object; }; taxId?: string; };",
    ],
    response:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'adoptions->retrieve',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$application = $client->adoptions->retrieve('applicationId');\n\nvar_dump($application);",
      },
      csharp: {
        method: 'Adoptions.Retrieve',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'adoptions->retrieveDecision',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->adoptions->retrieveDecision('applicationId');\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Adoptions.RetrieveDecision',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'adoptions->policies->list',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$page = $client->adoptions->policies->list(cursor: 'cursor', limit: 0);\n\nvar_dump($page);",
      },
      csharp: {
        method: 'Adoptions.Policies.List',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'adoptions->policies->retrieve',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$policy = $client->adoptions->policies->retrieve('policyId');\n\nvar_dump($policy);",
      },
      csharp: {
        method: 'Adoptions.Policies.Retrieve',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'adoptions->policies->update',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$policy = $client->adoptions->policies->update(\n  'policyId',\n  escalation: [\n    'operator' => 'ALL',\n    'groups' => [],\n    'rules' => [\n      [\n        'attribute' => RuleAttribute::PET_STATUS,\n        'operation' => 'IS_ONE_OF',\n        'value' => 'string',\n      ],\n    ],\n  ],\n  name: 'name',\n  notificationTarget: 'string',\n  actor: 'actor',\n  status: 'active',\n  actedAt: new \\DateTimeImmutable('2019-12-27T18:11:19.117Z'),\n  reason: 'reason',\n);\n\nvar_dump($policy);",
      },
      csharp: {
        method: 'Adoptions.Policies.Update',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'placements->list',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$page = $client->placements->list(cursor: 'cursor', limit: 0);\n\nvar_dump($page);",
      },
      csharp: {
        method: 'Placements.List',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'placements->retrieve',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$placement = $client->placements->retrieve('placementId');\n\nvar_dump($placement);",
      },
      csharp: {
        method: 'Placements.Retrieve',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'placements->recordEvent',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$placement = $client->placements->recordEvent(\n  'placementId',\n  id: 'id',\n  leg: [\n    'location' => [\n      'city' => 'Palo Alto',\n      'geo' => ['latitude' => 37.4443, 'longitude' => -122.1598],\n      'relatedCategory' => (object) [],\n      'relatedCustomer' => (object) [],\n      'relatedMoney' => [\n        'amount' => 2500,\n        'currency' => 'USD',\n        'relatedCategory' => (object) [],\n        'relatedCustomer' => (object) [],\n        'relatedOrder' => (object) [],\n        'relatedPet' => [\n          'name' => 'doggie',\n          'photoURLs' => ['string'],\n          'id' => 10,\n          'acquisitionChannel' => 'breeder',\n          'category' => (object) [],\n          'microchipID' => 'string',\n          'relatedCategory' => (object) [],\n          'relatedCustomer' => (object) [],\n          'relatedOrder' => (object) [],\n          'relatedShelter' => (object) [],\n          'relatedUser' => (object) [],\n          'status' => PetStatus::AVAILABLE,\n          'tags' => [(object) []],\n        ],\n        'relatedShelter' => (object) [],\n        'relatedTag' => (object) [],\n        'relatedUser' => (object) [],\n      ],\n      'relatedOrder' => (object) [],\n      'relatedPet' => [\n        'name' => 'doggie',\n        'photoURLs' => ['string'],\n        'id' => 10,\n        'acquisitionChannel' => 'breeder',\n        'category' => (object) [],\n        'microchipID' => 'string',\n        'relatedCategory' => (object) [],\n        'relatedCustomer' => (object) [],\n        'relatedOrder' => (object) [],\n        'relatedShelter' => (object) [],\n        'relatedUser' => (object) [],\n        'status' => PetStatus::AVAILABLE,\n        'tags' => [(object) []],\n      ],\n      'relatedShelter' => (object) [],\n      'relatedTag' => (object) [],\n      'relatedUser' => (object) [],\n      'state' => 'CA',\n      'street' => '437 Lytton',\n      'zip' => '94301',\n    ],\n    'contact' => ['name' => 'name', 'phone' => 'phone'],\n    'cost' => [\n      'amount' => 2500,\n      'currency' => 'USD',\n      'relatedCategory' => (object) [],\n      'relatedCustomer' => (object) [],\n      'relatedOrder' => (object) [],\n      'relatedShelter' => (object) [],\n      'relatedTag' => (object) [],\n      'relatedUser' => (object) [],\n    ],\n    'window' => [\n      'end' => new \\DateTimeImmutable('2019-12-27T18:11:19.117Z'),\n      'start' => new \\DateTimeImmutable('2019-12-27T18:11:19.117Z'),\n    ],\n  ],\n  occurredAt: new \\DateTimeImmutable('2019-12-27T18:11:19.117Z'),\n  type: 'disruption',\n  note: 'note',\n  followUp: [\n    'due' => new \\DateTimeImmutable('2019-12-27T18:11:19.117Z'),\n    'reason' => 'reason',\n  ],\n  record: [\n    'id' => 'id',\n    'administeredAt' => new \\DateTimeImmutable('2019-12-27T18:11:19.117Z'),\n    'vaccine' => 'vaccine',\n    'audit' => [\n      'recordedAt' => new \\DateTimeImmutable('2019-12-27T18:11:19.117Z'),\n      'recordedBy' => 'recordedBy',\n      'source' => 'manual',\n    ],\n    'boosterSchedule' => [\n      [\n        'due' => new \\DateTimeImmutable('2019-12-27T18:11:19.117Z'),\n        'completed' => true,\n        'dose' => 0,\n      ],\n    ],\n    'veterinarian' => [\n      'license' => ['number' => 'number', 'region' => 'region'],\n      'name' => 'name',\n    ],\n  ],\n  severity: 0,\n);\n\nvar_dump($placement);",
      },
      csharp: {
        method: 'Placements.RecordEvent',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        example:
          'package com.hello_world_testingggg.api.example;\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient;\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient;\nimport com.hello_world_testingggg.api.models.WebhookParsedParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        HelloWorldTestinggggClient client = HelloWorldTestinggggOkHttpClient.fromEnv();\n\n        client.webhooks().parsed();\n    }\n}',
      },
      kotlin: {
        example:
          'package com.hello_world_testingggg.api.example\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient\nimport com.hello_world_testingggg.api.models.WebhookParsedParams\n\nfun main() {\n    val client: HelloWorldTestinggggClient = HelloWorldTestinggggOkHttpClient.fromEnv()\n\n    client.webhooks().parsed()\n}',
  ...
  },
  {
    ...
    summary: '',
    description: '',
    stainlessPath: '(resource) notifications.webhooks > (method) parse_pet',
    qualified: 'client.notifications.webhooks.parsePet',
    perLanguage: {
      typescript: {
        method: 'client.notifications.webhooks.parsePet',
        example:
          "import HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nawait client.notifications.webhooks.parsePet();",
      },
      python: {
        method: 'notifications.webhooks.parse_pet',
        example:
          'from hello_world_testingggg import HelloWorldTestingggg\n\nclient = HelloWorldTestingggg()\nclient.notifications.webhooks.parse_pet()',
      },
      java: {
        example:
          'package com.hello_world_testingggg.api.example;\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient;\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient;\nimport com.hello_world_testingggg.api.models.NotificationWebhookParsePetParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        HelloWorldTestinggggClient client = HelloWorldTestinggggOkHttpClient.fromEnv();\n\n        client.notifications().webhooks().parsePet();\n    }\n}',
      },
      kotlin: {
        example:
          'package com.hello_world_testingggg.api.example\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient\nimport com.hello_world_testingggg.api.models.NotificationWebhookParsePetParams\n\nfun main() {\n    val client: HelloWorldTestinggggClient = HelloWorldTestinggggOkHttpClient.fromEnv()\n\n    client.notifications().webhooks().parsePet()\n}',
      ...
      go: {
        method: 'client.Notifications.Webhooks.ParsePet',
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/swagger-girly/go"\n\t"github.com/swagger-girly/go/option"\n)\n\nfunc main() {\n\tclient := helloworldtestingggg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithBasicAuthUsername("My Basic Auth Username"),\n\t\toption.WithBasicAuthPassword("My Basic Auth Password"),\n\t)\n\terr := client.Notifications.Webhooks.ParsePet(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      ruby: {
        method: 'notifications.webhooks.parse_pet',
        example:
      ...
      php: {
        ...
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(\n  apiKey: 'My API Key',\n  basicAuthUsername: 'My Basic Auth Username',\n  basicAuthPassword: 'My Basic Auth Password',\n);\n\n$result = $client->notifications->webhooks->parsePet();\n\nvar_dump($result);",
      },
      csharp: {
        example:
  ...
  },
  {
    ...
    endpoint: '/store/activity/{activityId}',
    httpMethod: 'get',
    summary: 'Retrieve one store activity entry',
    description:
      "Returns a single activity feed entry. The response is a discriminated union whose arms each compose the public `Pet` model, so every arm is minted under the response's namespace and must inherit rather than flatten.",
    stainlessPath: '(resource) store > (method) retrieve_activity',
    qualified: 'client.store.retrieveActivity',
    params: ['activityId: string;'],
    response: 'object | object | object | object',
    markdown:
      "## retrieve_activity\n\n`client.store.retrieveActivity(activityId: string): object | object | object | object`\n\n**get** `/store/activity/{activityId}`\n\nReturns a single activity feed entry. The response is a discriminated union whose arms each compose the public `Pet` model, so every arm is minted under the response's namespace and must inherit rather than flatten.\n\n### Parameters\n\n- `activityId: string`\n\n### Returns\n\n- `{ name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; } | { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; } | { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; } | { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  A store activity feed entry. Every arm composes the public `Pet` model, so each one is minted under the response's namespace and inherits from `Pet` instead of re-minting its inline type tree.\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst response = await client.store.retrieveActivity('activityId');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.store.retrieveActivity',
        example:
          "import HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg({\n  apiKey: process.env['API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.store.retrieveActivity('activityId');\n\nconsole.log(response);",
      },
      python: {
        ...
        example:
          'import os\nfrom hello_world_testingggg import HelloWorldTestingggg\n\nclient = HelloWorldTestingggg(\n    api_key=os.environ.get("API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.store.retrieve_activity(\n    "activityId",\n)\nprint(response)',
      },
      java: {
        method: 'store().retrieveActivity',
        example:
          'package com.hello_world_testingggg.api.example;\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient;\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient;\nimport com.hello_world_testingggg.api.models.StoreRetrieveActivityParams;\nimport com.hello_world_testingggg.api.models.StoreRetrieveActivityResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        HelloWorldTestinggggClient client = HelloWorldTestinggggOkHttpClient.fromEnv();\n\n        StoreRetrieveActivityResponse response = client.store().retrieveActivity("activityId");\n    }\n}',
      },
      kotlin: {
        method: 'store().retrieveActivity',
        example:
          'package com.hello_world_testingggg.api.example\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient\nimport com.hello_world_testingggg.api.models.StoreRetrieveActivityParams\nimport com.hello_world_testingggg.api.models.StoreRetrieveActivityResponse\n\nfun main() {\n    val client: HelloWorldTestinggggClient = HelloWorldTestinggggOkHttpClient.fromEnv()\n\n    val response: StoreRetrieveActivityResponse = client.store().retrieveActivity("activityId")\n}',
      },
      go: {
        method: 'client.Store.GetActivity',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/swagger-girly/go"\n\t"github.com/swagger-girly/go/option"\n)\n\nfunc main() {\n\tclient := helloworldtestingggg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Store.GetActivity(context.TODO(), "activityId")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      ruby: {
        method: 'store.retrieve_activity',
        example:
      ...
      php: {
        method: 'store->retrieveActivity',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->store->retrieveActivity('activityId');\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Store.RetrieveActivity',
        example:
  ...
  },
  {
    ...
    response:
      "{ id?: number; complete?: boolean; petId?: number; quantity?: number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; shipDate?: string; status?: 'placed' | 'approved' | 'delivered'; total?: object; }",
    markdown:
      "## create\n\n`client.store.order.create(id?: number, complete?: boolean, petId?: number, quantity?: number, relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }, relatedCategory?: object, relatedCustomer?: object, relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }, relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }, relatedShelter?: object, relatedTag?: object, relatedUser?: object, shipDate?: string, status?: 'placed' | 'approved' | 'delivered', total?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }): { id?: number; complete?: boolean; petId?: number; quantity?: number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; shipDate?: string; status?: 'placed' | 'approved' | 'delivered'; total?: money; }`\n\n**post** `/store/order`\n\nPlace a new order in the store\n\n### Parameters\n\n- `id?: number`\n\n- `complete?: boolean`\n\n- `petId?: number`\n\n- `quantity?: number`\n\n- `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `city?: string`\n  - `geo?: { latitude: number; longitude: number; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n  - `state?: string`\n  - `street?: string`\n  - `zip?: string`\n\n- `relatedCategory?: object`\n\n- `relatedCustomer?: object`\n\n- `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `amount: number`\n    Amount in minor currency units (e.g. cents).\n  - `currency: string`\n    ISO 4217 currency code.\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n\n- `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `name: string`\n  - `photoUrls: string[]`\n  - `id?: number`\n  - `acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string`\n    How the pet entered the store. Open enum: known channels plus forward-compatible free-form strings.\n  - `category?: object`\n  - `microchipId?: string | number`\n    Microchip identifier; legacy chips used numeric identifiers.\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedUser?: object`\n  - `status?: 'available' | 'pending' | 'sold'`\n    pet status in the store\n  - `tags?: object[]`\n\n- `relatedShelter?: object`\n\n- `relatedTag?: object`\n\n- `relatedUser?: object`\n\n- `shipDate?: string`\n\n- `status?: 'placed' | 'approved' | 'delivered'`\n  Order Status\n\n- `total?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `amount: number`\n    Amount in minor currency units (e.g. cents).\n  - `currency: string`\n    ISO 4217 currency code.\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n\n### Returns\n\n- `{ id?: number; complete?: boolean; petId?: number; quantity?: number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; shipDate?: string; status?: 'placed' | 'approved' | 'delivered'; total?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; }`\n\n  - `id?: number`\n  - `complete?: boolean`\n  - `petId?: number`\n  - `quantity?: number`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n  - `shipDate?: string`\n  - `status?: 'placed' | 'approved' | 'delivered'`\n  - `total?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst order = await client.store.order.create();\n\nconsole.log(order);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id?: number; complete?: boolean; petId?: number; quantity?: number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; shipDate?: string; status?: 'placed' | 'approved' | 'delivered'; total?: object; }",
    markdown:
      "## retrieve\n\n`client.store.order.retrieve(orderId: number): { id?: number; complete?: boolean; petId?: number; quantity?: number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; shipDate?: string; status?: 'placed' | 'approved' | 'delivered'; total?: money; }`\n\n**get** `/store/order/{orderId}`\n\nFor valid response try integer IDs with value <= 5 or > 10. Other values will generate exceptions.\n\n### Parameters\n\n- `orderId: number`\n\n### Returns\n\n- `{ id?: number; complete?: boolean; petId?: number; quantity?: number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; shipDate?: string; status?: 'placed' | 'approved' | 'delivered'; total?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; }`\n\n  - `id?: number`\n  - `complete?: boolean`\n  - `petId?: number`\n  - `quantity?: number`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n  - `shipDate?: string`\n  - `status?: 'placed' | 'approved' | 'delivered'`\n  - `total?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst order = await client.store.order.retrieve(0);\n\nconsole.log(order);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'store->reports->list',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$page = $client->store->reports->list(\n  endingBefore: 'ending_before', pageSize: 0, startingAfter: 'starting_after'\n);\n\nvar_dump($page);",
      },
      csharp: {
        method: 'Store.Reports.List',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'store->reports->retrieve',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$report = $client->store->reports->retrieve('reportId');\n\nvar_dump($report);",
      },
      csharp: {
        method: 'Store.Reports.Retrieve',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'store->reports->embed',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->store->reports->embed('reportId');\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Store.Reports.Embed',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'store->reports->pause',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$result = $client->store->reports->pause(\n  'reportId', idempotencyKey: 'report-pause-123'\n);\n\nvar_dump($result);",
      },
      csharp: {
        method: 'Store.Reports.Pause',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'store->reports->inventory->list',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$inventoryResponse = $client->store->reports->inventory->list('reportId');\n\nvar_dump($inventoryResponse);",
      },
      csharp: {
        method: 'Store.Reports.Inventory.List',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'store->reports->inventory->daily->retrieve',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$dailyInventory = $client->store->reports->inventory->daily->retrieve(\n  '2019-12-27', reportID: 'reportId'\n);\n\nvar_dump($dailyInventory);",
      },
      csharp: {
        method: 'Store.Reports.Inventory.Daily.Retrieve',
        example:
  ...
  },
  {
    ...
    response:
      '{ id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }',
    markdown:
      "## create\n\n`client.user.create(id?: number, email?: string, firstName?: string, lastName?: string, password?: string, phone?: string, relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }, relatedCategory?: object, relatedCustomer?: object, relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }, relatedOrder?: object, relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }, relatedShelter?: object, relatedTag?: object, username?: string, userStatus?: number): { id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }`\n\n**post** `/user`\n\nThis can only be done by the logged in user.\n\n### Parameters\n\n- `id?: number`\n\n- `email?: string`\n\n- `firstName?: string`\n\n- `lastName?: string`\n\n- `password?: string`\n\n- `phone?: string`\n\n- `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `city?: string`\n  - `geo?: { latitude: number; longitude: number; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n  - `state?: string`\n  - `street?: string`\n  - `zip?: string`\n\n- `relatedCategory?: object`\n\n- `relatedCustomer?: object`\n\n- `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `amount: number`\n    Amount in minor currency units (e.g. cents).\n  - `currency: string`\n    ISO 4217 currency code.\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n\n- `relatedOrder?: object`\n\n- `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `name: string`\n  - `photoUrls: string[]`\n  - `id?: number`\n  - `acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string`\n    How the pet entered the store. Open enum: known channels plus forward-compatible free-form strings.\n  - `category?: object`\n  - `microchipId?: string | number`\n    Microchip identifier; legacy chips used numeric identifiers.\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedUser?: object`\n  - `status?: 'available' | 'pending' | 'sold'`\n    pet status in the store\n  - `tags?: object[]`\n\n- `relatedShelter?: object`\n\n- `relatedTag?: object`\n\n- `username?: string`\n\n- `userStatus?: number`\n  User Status\n\n### Returns\n\n- `{ id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }`\n\n  - `id?: number`\n  - `email?: string`\n  - `firstName?: string`\n  - `lastName?: string`\n  - `password?: string`\n  - `phone?: string`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `username?: string`\n  - `userStatus?: number`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst user = await client.user.create();\n\nconsole.log(user);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      "body?: { id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }[];",
    ],
    response:
      '{ id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }',
    markdown:
      "## create_with_list\n\n`client.user.createWithList(body?: { id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }[]): { id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }`\n\n**post** `/user/createWithList`\n\nCreates list of users with given input array\n\n### Parameters\n\n- `body?: { id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }[]`\n\n### Returns\n\n- `{ id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }`\n\n  - `id?: number`\n  - `email?: string`\n  - `firstName?: string`\n  - `lastName?: string`\n  - `password?: string`\n  - `phone?: string`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `username?: string`\n  - `userStatus?: number`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst response = await client.user.createWithList();\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      php: {
        method: 'user->createWithList',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(\n  apiKey: 'My API Key',\n  basicAuthUsername: 'My Basic Auth Username',\n  basicAuthPassword: 'My Basic Auth Password',\n);\n\n$response = $client->user->createWithList(\n  body: [\n    [\n      'id' => 10,\n      'email' => 'john@email.com',\n      'firstName' => 'John',\n      'lastName' => 'James',\n      'password' => '12345',\n      'phone' => '12345',\n      'relatedAddress' => [\n        'city' => 'Palo Alto',\n        'geo' => ['latitude' => 37.4443, 'longitude' => -122.1598],\n        'relatedCategory' => (object) [],\n        'relatedCustomer' => (object) [],\n        'relatedMoney' => [\n          'amount' => 2500,\n          'currency' => 'USD',\n          'relatedCategory' => (object) [],\n          'relatedCustomer' => (object) [],\n          'relatedOrder' => (object) [],\n          'relatedPet' => [\n            'name' => 'doggie',\n            'photoURLs' => ['string'],\n            'id' => 10,\n            'acquisitionChannel' => 'breeder',\n            'category' => (object) [],\n            'microchipID' => 'string',\n            'relatedCategory' => (object) [],\n            'relatedCustomer' => (object) [],\n            'relatedOrder' => (object) [],\n            'relatedShelter' => (object) [],\n            'relatedUser' => (object) [],\n            'status' => PetStatus::AVAILABLE,\n            'tags' => [(object) []],\n          ],\n          'relatedShelter' => (object) [],\n          'relatedTag' => (object) [],\n          'relatedUser' => (object) [],\n        ],\n        'relatedOrder' => (object) [],\n        'relatedPet' => [\n          'name' => 'doggie',\n          'photoURLs' => ['string'],\n          'id' => 10,\n          'acquisitionChannel' => 'breeder',\n          'category' => (object) [],\n          'microchipID' => 'string',\n          'relatedCategory' => (object) [],\n          'relatedCustomer' => (object) [],\n          'relatedOrder' => (object) [],\n          'relatedShelter' => (object) [],\n          'relatedUser' => (object) [],\n          'status' => PetStatus::AVAILABLE,\n          'tags' => [(object) []],\n        ],\n        'relatedShelter' => (object) [],\n        'relatedTag' => (object) [],\n        'relatedUser' => (object) [],\n        'state' => 'CA',\n        'street' => '437 Lytton',\n        'zip' => '94301',\n      ],\n      'relatedMoney' => [\n        'amount' => 2500,\n        'currency' => 'USD',\n        'relatedCategory' => (object) [],\n        'relatedCustomer' => (object) [],\n        'relatedOrder' => (object) [],\n        'relatedShelter' => (object) [],\n        'relatedTag' => (object) [],\n        'relatedUser' => (object) [],\n      ],\n      'relatedPet' => [\n        'name' => 'doggie',\n        'photoURLs' => ['string'],\n        'id' => 10,\n        'acquisitionChannel' => 'breeder',\n        'category' => (object) [],\n        'microchipID' => 'string',\n        'relatedCategory' => (object) [],\n        'relatedCustomer' => (object) [],\n        'relatedOrder' => (object) [],\n        'relatedShelter' => (object) [],\n        'relatedUser' => (object) [],\n        'status' => PetStatus::AVAILABLE,\n        'tags' => [(object) []],\n      ],\n      'username' => 'theUser',\n      'userStatus' => 1,\n    ],\n  ],\n);\n\nvar_dump($response);",
      },
      csharp: {
        method: 'User.CreateWithList',
        example:
  ...
  },
  {
    ...
    response:
      '{ id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: object; relatedOrder?: object; relatedPet?: object; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }',
    markdown:
      "## retrieve\n\n`client.user.retrieve(username: string): { id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }`\n\n**get** `/user/{username}`\n\nGet user by user name\n\n### Parameters\n\n- `username: string`\n\n### Returns\n\n- `{ id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; username?: string; userStatus?: number; }`\n\n  - `id?: number`\n  - `email?: string`\n  - `firstName?: string`\n  - `lastName?: string`\n  - `password?: string`\n  - `phone?: string`\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `username?: string`\n  - `userStatus?: number`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst user = await client.user.retrieve('username');\n\nconsole.log(user);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    markdown:
      "## update\n\n`client.user.update(username: string, id?: number, email?: string, firstName?: string, lastName?: string, password?: string, phone?: string, relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }, relatedCategory?: object, relatedCustomer?: object, relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }, relatedOrder?: object, relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }, relatedShelter?: object, relatedTag?: object, username?: string, userStatus?: number): void`\n\n**put** `/user/{username}`\n\nThis can only be done by the logged in user.\n\n### Parameters\n\n- `username: string`\n\n- `id?: number`\n\n- `email?: string`\n\n- `firstName?: string`\n\n- `lastName?: string`\n\n- `password?: string`\n\n- `phone?: string`\n\n- `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `city?: string`\n  - `geo?: { latitude: number; longitude: number; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n  - `state?: string`\n  - `street?: string`\n  - `zip?: string`\n\n- `relatedCategory?: object`\n\n- `relatedCustomer?: object`\n\n- `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `amount: number`\n    Amount in minor currency units (e.g. cents).\n  - `currency: string`\n    ISO 4217 currency code.\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedTag?: object`\n  - `relatedUser?: object`\n\n- `relatedOrder?: object`\n\n- `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `name: string`\n  - `photoUrls: string[]`\n  - `id?: number`\n  - `acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string`\n    How the pet entered the store. Open enum: known channels plus forward-compatible free-form strings.\n  - `category?: object`\n  - `microchipId?: string | number`\n    Microchip identifier; legacy chips used numeric identifiers.\n  - `relatedAddress?: { city?: string; geo?: { latitude: number; longitude: number; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }`\n  - `relatedCategory?: object`\n  - `relatedCustomer?: object`\n  - `relatedMoney?: { amount: number; currency: string; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }`\n  - `relatedOrder?: object`\n  - `relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: { city?: string; geo?: object; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; state?: string; street?: string; zip?: string; }; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: { amount: number; currency: string; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedTag?: object; relatedUser?: object; }; relatedOrder?: object; relatedPet?: { name: string; photoUrls: string[]; id?: number; acquisitionChannel?: 'breeder' | 'shelter' | 'surrender' | 'transfer' | string; category?: object; microchipId?: string | number; relatedAddress?: address; relatedCategory?: object; relatedCustomer?: object; relatedMoney?: money; relatedOrder?: object; relatedPet?: pet; relatedShelter?: object; relatedUser?: object; status?: pet_status; tags?: object[]; }; relatedShelter?: object; relatedUser?: object; status?: 'available' | 'pending' | 'sold'; tags?: object[]; }`\n  - `relatedShelter?: object`\n  - `relatedUser?: object`\n  - `status?: 'available' | 'pending' | 'sold'`\n    pet status in the store\n  - `tags?: object[]`\n\n- `relatedShelter?: object`\n\n- `relatedTag?: object`\n\n- `username?: string`\n\n- `userStatus?: number`\n  User Status\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nawait client.user.update('username')\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'user->verifyIdentity',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->user->verifyIdentity('username');\n\nvar_dump($response);",
      },
      csharp: {
        method: 'User.VerifyIdentity',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'ai->aiQuery',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->ai->aiQuery(\n  dataToExtract: [\n    ['datapointName' => 'datapoint_name', 'datapointType' => 'text']\n  ],\n  domain: 'domain',\n  authentication3DS: [\n    'challengeRules' => [['challengeKind' => 'challenge_kind']],\n    'fallbackCheck' => [['checkName' => 'check_name']],\n  ],\n  datapointObjectSchema: ['foo' => 'string'],\n  extractionRules: [['ruleName' => 'rule_name', 'ruleSeverity' => 'low']],\n);\n\nvar_dump($response);",
      },
      csharp: {
        method: 'AI.AIQuery',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'media->textFirst',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->media->textFirst();\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Media.TextFirst',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'media->jsonFirst',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->media->jsonFirst();\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Media.JsonFirst',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'media->jsonAndXml',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->media->jsonAndXml();\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Media.JsonAndXml',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'media->textOnly',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->media->textOnly();\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Media.TextOnly',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'media->schemaOnText',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$result = $client->media->schemaOnText();\n\nvar_dump($result);",
      },
      csharp: {
        method: 'Media.SchemaOnText',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'media->schemaOnJson',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->media->schemaOnJson();\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Media.SchemaOnJson',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'media->vendorJson',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->media->vendorJson();\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Media.VendorJson',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      php: {
        method: 'media->binaryAndJson',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->media->binaryAndJson();\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Media.BinaryAndJson',
        example:
