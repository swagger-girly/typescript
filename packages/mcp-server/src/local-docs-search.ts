...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ petId: number; badge?: {  }; docsRef?: string; rank?: number; roi?: { currency?: string; times?: number; }; streak7d?: number; }[]',
    markdown:
      "## list_leaderboard\n\n`client.pet.listLeaderboard(): { petId: number; badge?: object; docsRef?: string; rank?: number; roi?: object; streak7d?: number; }[]`\n\n**get** `/pet/leaderboard`\n\nReturns a bare top-level array of inline objects so generators must mint a distinct element type instead of reusing the response alias name.\n\n### Returns\n\n- `{ petId: number; badge?: {  }; docsRef?: string; rank?: number; roi?: { currency?: string; times?: number; }; streak7d?: number; }[]`\n\n### Example\n\n```typescript\nimport HelloWorldTestingggg from 'hello-world-testingggg';\n\nconst client = new HelloWorldTestingggg();\n\nconst response = await client.pet.listLeaderboard();\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/swagger-girly/go"\n\t"github.com/swagger-girly/go/option"\n)\n\nfunc main() {\n\tclient := helloworldtestingggg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Pet.GetPremium(context.TODO(), 0)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      ruby: {
        method: 'pet.retrieve_premium',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      go: {
        method: 'client.Profiles.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/swagger-girly/go"\n\t"github.com/swagger-girly/go/option"\n)\n\nfunc main() {\n\tclient := helloworldtestingggg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tprofile, err := client.Profiles.Update(\n\t\tcontext.TODO(),\n\t\t"profileId",\n\t\thelloworldtestingggg.ProfileUpdateParams{\n\t\t\tOfProfileDetailsUpdate: &helloworldtestingggg.ProfileUpdateParamsBodyProfileDetailsUpdate{},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", profile.ID)\n}\n',
      },
      ruby: {
        method: 'profiles.update',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/swagger-girly/go"\n\t"github.com/swagger-girly/go/option"\n)\n\nfunc main() {\n\tclient := helloworldtestingggg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpolicy, err := client.Adoptions.Policies.New(context.TODO(), helloworldtestingggg.AdoptionPolicyNewParams{\n\t\tName: "name",\n\t\tRules: []helloworldtestingggg.AdoptionRuleParam{{\n\t\t\tAttribute: helloworldtestingggg.RuleAttributePetStatus,\n\t\t\tOperation: helloworldtestingggg.AdoptionRuleOperationIsOneOf,\n\t\t}},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", policy.ID)\n}\n',
      },
      ruby: {
        method: 'adoptions.policies.create',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      go: {
        method: 'client.Adoptions.Policies.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/swagger-girly/go"\n\t"github.com/swagger-girly/go/option"\n)\n\nfunc main() {\n\tclient := helloworldtestingggg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpolicy, err := client.Adoptions.Policies.Update(\n\t\tcontext.TODO(),\n\t\t"policyId",\n\t\thelloworldtestingggg.AdoptionPolicyUpdateParams{\n\t\t\tOfAdoptionPolicyDetailsUpdate: &helloworldtestingggg.AdoptionPolicyUpdateParamsBodyAdoptionPolicyDetailsUpdate{},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", policy.ID)\n}\n',
      },
      ruby: {
        method: 'adoptions.policies.update',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      go: {
        method: 'client.Placements.RecordEvent',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\t"time"\n\n\t"github.com/swagger-girly/go"\n\t"github.com/swagger-girly/go/option"\n\t"github.com/swagger-girly/go/shared"\n)\n\nfunc main() {\n\tclient := helloworldtestingggg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tplacement, err := client.Placements.RecordEvent(\n\t\tcontext.TODO(),\n\t\t"placementId",\n\t\thelloworldtestingggg.PlacementRecordEventParams{\n\t\t\tPlacementEvent: helloworldtestingggg.PlacementEventUnionParam{\n\t\t\t\tOfPlacementEventPlacementTransferEvent: &helloworldtestingggg.PlacementEventPlacementTransferEventParam{\n\t\t\t\t\tID: "id",\n\t\t\t\t\tLeg: helloworldtestingggg.TransferLegParam{\n\t\t\t\t\t\tLocation: shared.AddressParam{},\n\t\t\t\t\t},\n\t\t\t\t\tOccurredAt: time.Now(),\n\t\t\t\t\tType:       "transfer",\n\t\t\t\t},\n\t\t\t},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", placement.ID)\n}\n',
      },
      ruby: {
        method: 'placements.record_event',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        example:
          'package com.hello_world_testingggg.api.example;\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient;\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient;\nimport com.hello_world_testingggg.api.models.notifications.webhooks.WebhookParsePetParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        HelloWorldTestinggggClient client = HelloWorldTestinggggOkHttpClient.fromEnv();\n\n        client.notifications().webhooks().parsePet();\n    }\n}',
      },
      kotlin: {
        example:
          'package com.hello_world_testingggg.api.example\n\nimport com.hello_world_testingggg.api.client.HelloWorldTestinggggClient\nimport com.hello_world_testingggg.api.client.okhttp.HelloWorldTestinggggOkHttpClient\nimport com.hello_world_testingggg.api.models.notifications.webhooks.WebhookParsePetParams\n\nfun main() {\n    val client: HelloWorldTestinggggClient = HelloWorldTestinggggOkHttpClient.fromEnv()\n\n    client.notifications().webhooks().parsePet()\n}',
