...
import { HelloWorldTestingggg, ClientOptions } from 'hello-world-testingggg';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: HelloWorldTestingggg)`
    : `const run: (${functionSource.client}: HelloWorldTestingggg) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.files.createArchive',
    'client.files.delete',
    'client.files.download',
    'client.files.list',
    'client.files.update',
    'client.files.upload',
    'client.files.uploadDirect',
    'client.profiles.create',
    'client.profiles.legacySearch',
    'client.profiles.retrieve',
    'client.profiles.update',
    'client.adoptions.create',
    'client.adoptions.retrieve',
    'client.adoptions.retrieveDecision',
    'client.adoptions.policies.create',
    'client.adoptions.policies.list',
    'client.adoptions.policies.retrieve',
    'client.adoptions.policies.update',
    'client.placements.create',
    'client.placements.list',
    'client.placements.recordEvent',
    'client.placements.retrieve',
    ...
    'client.store.reports.embed',
    'client.store.reports.list',
    'client.store.reports.pause',
    'client.store.reports.retrieve',
    'client.store.reports.inventory.list',
    'client.store.reports.inventory.daily.retrieve',
    'client.user.create',
    ...
    'client.media.schemaOnJson',
    'client.media.schemaOnText',
    'client.media.textFirst',
    'client.media.textOnly',
    'client.media.vendorJson',
  ],
